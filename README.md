...
│   │   ├── index.ts          # aggregates all 3,880 problems (PROBLEMS, CATEGORIES)
...
```bash
bun run scripts/verify-problems.ts   # structural checks + real-Python execution of all 3,880 solutions
