...
Written 2026-09-13; refreshed 2026-09-14 after waves 27–29 and 2026-09-17 after waves 32–33.
...
| 19 | Search & shortcuts | Done | Palette search across problems, paths, articles, and blog (generated light article index), plus all 5 research challenges and 8 labs (title + keyword scoring) + quick actions (labs, lab trails, research); g-sequences and a `?` overlay |
